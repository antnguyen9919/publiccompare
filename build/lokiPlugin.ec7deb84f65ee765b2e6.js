    ...
    function LokiDatasource(instanceSettings, backendSrv, templateSrv) {
        ...
        _this.getLogRowContext = function (row, options) {
            ...
            return _this._request(RANGE_QUERY_ENDPOINT, target)
                ...
                return Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["iif"])(function () { return res.status === 404; }, Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["defer"])(function () {
                    return _this._request(LEGACY_QUERY_ENDPOINT, target).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(function (err) {
                        var error = {
                            message: 'Error during context query. Please check JS console logs.',
                            status: err.status,
                            statusText: err.statusText,
                ...
                }), Object(rxjs__WEBPACK_IMPORTED_MODULE_2__["defer"])(function () {
...
//# sourceMappingURL=lokiPlugin.ec7deb84f65ee765b2e6.js.map