...
/* harmony import */ var _selectors__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./selectors */ "./public/app/features/datasources/state/selectors.ts");
...
var initDataSourceSettings = function (pageId, dependencies) {
    ...
    return function (dispatch, getState) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function () {
        var dataSource, dataSourceMeta, importedPlugin, err_1;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (isNaN(pageId)) {
                        dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_8__["initDataSourceSettingsFailed"])(new Error('Invalid ID')));
                        return [2 /*return*/];
                    }
                    _a.label = 1;
                case 1:
                ...
                case 3:
                    ...
                    dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_8__["initDataSourceSettingsSucceeded"])(importedPlugin));
                    return [3 /*break*/, 5];
                case 4:
                    err_1 = _a.sent();
                    console.log('Failed to import plugin module', err_1);
                    dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_8__["initDataSourceSettingsFailed"])(err_1));
                    return [3 /*break*/, 5];
...
var testDataSource = function (dataSourceName, dependencies) {
    if (dependencies === void 0) { dependencies = {
        getDatasourceSrv: app_features_plugins_datasource_srv__WEBPACK_IMPORTED_MODULE_3__["getDatasourceSrv"],
        getBackendSrv: app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"],
    }; }
    return function (dispatch, getState) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function () {
        var dsApi;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_8__["testDataSourceStarting"])());
                    dependencies.getBackendSrv().withNoBackendCache(function () { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function () {
                        ...
                        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 1:
                                    result = _a.sent();
                                    dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_8__["testDataSourceSucceeded"])(result));
                                    return [3 /*break*/, 3];
                                case 2:
                                    err_2 = _a.sent();
                                    message = '';
                                    ...
                                    dispatch(Object(_reducers__WEBPACK_IMPORTED_MODULE_8__["testDataSourceFailed"])({ message: message }));
                                    return [3 /*break*/, 3];
...
function loadDataSources() {
    ...
    return function (dispatch) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Object(app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])().get('/api/datasources')];
                case 1:
                    response = _a.sent();
...
function loadDataSource(id) {
    ...
    return function (dispatch) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Object(app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])().get("/api/datasources/" + id)];
                case 1:
                    dataSource = _a.sent();
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Object(app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])().post('/api/datasources', newInstance)];
                case 2:
                    result = _a.sent();
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Object(app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])().get('/api/plugins', { enabled: 1, type: 'datasource' })];
                case 1:
                    plugins = _a.sent();
...
function updateDataSource(dataSource) {
    ...
    return function (dispatch) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, Object(app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])().put("/api/datasources/" + dataSource.id, dataSource)];
                case 1:
                    _a.sent();
        ...
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, Object(app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])().delete("/api/datasources/" + dataSource.id)];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, updateFrontendSettings()];
                case 2:
...
function updateFrontendSettings() {
    return Object(app_core_services_backend_srv__WEBPACK_IMPORTED_MODULE_2__["getBackendSrv"])()
...
//# sourceMappingURL=default~DataSourceDashboards~DataSourceSettingsPage~DataSourcesListPage~NewDataSourcePage.ec7deb84f65ee765b2e6.js.map