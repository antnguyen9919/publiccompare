...
function PromExploreExtraField(props) {
    var label = props.label, onChangeFunc = props.onChangeFunc, onKeyDownFunc = props.onKeyDownFunc, value = props.value, hasTooltip = props.hasTooltip, tooltipContent = props.tooltipContent;
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "gf-form-inline explore-input--ml" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "gf-form" },
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["FormLabel"], { width: 5, tooltip: hasTooltip ? tooltipContent : null }, label),
            react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("input", { type: 'text', className: "gf-form-input width-4", placeholder: 'auto', onChange: onChangeFunc, onKeyDown: onKeyDownFunc, value: value }))));
}
...
/* harmony import */ var _PromQueryField__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./PromQueryField */ "./public/app/plugins/datasource/prometheus/components/PromQueryField.tsx");
/* harmony import */ var _PromExploreExtraField__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./PromExploreExtraField */ "./public/app/plugins/datasource/prometheus/components/PromExploreExtraField.tsx");




function PromExploreQueryEditor(props) {
    var query = props.query, data = props.data, datasource = props.datasource, history = props.history, onChange = props.onChange, onRunQuery = props.onRunQuery;
    function onChangeQueryStep(value) {
        var query = props.query, onChange = props.onChange;
        var nextQuery = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, query), { interval: value });
        onChange(nextQuery);
    }
    ...
    return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_PromQueryField__WEBPACK_IMPORTED_MODULE_2__["default"], { datasource: datasource, query: query, onRunQuery: onRunQuery, onChange: onChange, history: history, data: data, ExtraFieldElement: react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_PromExploreExtraField__WEBPACK_IMPORTED_MODULE_3__["PromExploreExtraField"], { label: 'Step', onChangeFunc: onStepChange, onKeyDownFunc: onReturnKeyDown, value: query.interval || '', hasTooltip: true, tooltipContent: 'Needs to be a valid time unit string, for example 5s, 1m, 3h, 1d, 1y' }) }));
}
/* harmony default export */ __webpack_exports__["default"] = (Object(react__WEBPACK_IMPORTED_MODULE_1__["memo"])(PromExploreQueryEditor));
...
var PromQueryField = /** @class */ (function (_super) {
    ...
    PromQueryField.prototype.render = function () {
        var _a = this.props, data = _a.data, query = _a.query, ExtraFieldElement = _a.ExtraFieldElement;
...
var ConfigEditor = function (props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_0___default.a.Fragment, null,
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_grafana_ui__WEBPACK_IMPORTED_MODULE_1__["DataSourceHttpSettings"], { defaultUrl: "http://localhost:9090", dataSourceConfig: options, showAccessOptions: true, onChange: onOptionsChange }),
...
var PrometheusDatasource = /** @class */ (function (_super) {
    ...
    function PrometheusDatasource(instanceSettings) {
        ...
        _this.createAnnotationQueryOptions = function (options) {
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])(Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__assign"])({}, options), { interval: interval });
        };
    ...
    PrometheusDatasource.prototype.annotationQuery = function (options) {
        var _a, _b, _c, _d;
        return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, function () {
            var annotation, _e, expr, _f, tagKeys, _g, titleFormat, _h, textFormat, start, end, queryOptions, minStep, queryModel, query, self, response, eventList, splitKeys;
...
var plugin = new _grafana_data__WEBPACK_IMPORTED_MODULE_0__["DataSourcePlugin"](_datasource__WEBPACK_IMPORTED_MODULE_1__["PrometheusDatasource"])
    ...
    .setExploreMetricsQueryField(_components_PromExploreQueryEditor__WEBPACK_IMPORTED_MODULE_4__["default"])
...
//# sourceMappingURL=prometheusPlugin.ec7deb84f65ee765b2e6.js.map