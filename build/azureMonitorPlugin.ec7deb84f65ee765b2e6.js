...
var ConfigEditor = /** @class */ (function (_super) {
    ...
    ConfigEditor.prototype.render = function () {
        ...
        return (react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(react__WEBPACK_IMPORTED_MODULE_1___default.a.Fragment, null,
            ...
            react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(_InsightsConfig__WEBPACK_IMPORTED_MODULE_7__["InsightsConfig"], { options: options, onUpdateOption: this.updateOption, onUpdateSecureOption: this.updateSecureOption, onResetOptionKey: this.resetKey })));
    };
    return ConfigEditor;
}(react__WEBPACK_IMPORTED_MODULE_1__["PureComponent"]));
...
var InsightsConfig = /** @class */ (function (_super) {
    ...
    function InsightsConfig() {
        ...
        _this.onAppInsightsAppIdChange = function (event) {
            _this.props.onUpdateOption('appInsightsAppId', event.target.value);
        };
        _this.onAppInsightsApiKeyChange = function (event) {
            _this.props.onUpdateSecureOption('appInsightsApiKey', event.target.value);
        };
...
//# sourceMappingURL=azureMonitorPlugin.ec7deb84f65ee765b2e6.js.map