...
var ElasticResponse = /** @class */ (function () {
    ...
    ElasticResponse.prototype.getLogs = function (logMessageField, logLevelField) {
        ...
        for (var n = 0; n < this.response.responses.length; n++) {
            ...
            var _b = flattenHits(response.hits.hits), propNames = _b.propNames, docs = _b.docs;
            if (docs.length > 0) {
                var series = createEmptyDataFrame(propNames, this.targets[0].timeField, logMessageField, logLevelField);
                try {
 ...
 * @param logLevelField
 */
var createEmptyDataFrame = function (propNames, timeField, logMessageField, logLevelField) {
    var e_9, _a;
    ...
    try {
        for (var propNames_1 = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__values"])(propNames), propNames_1_1 = propNames_1.next(); !propNames_1_1.done; propNames_1_1 = propNames_1.next()) {
...
//# sourceMappingURL=elasticsearchPlugin.ec7deb84f65ee765b2e6.js.map